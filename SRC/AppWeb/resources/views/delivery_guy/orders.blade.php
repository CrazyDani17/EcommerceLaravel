                        ...
                        <article class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-auto">
                                    ...
                                    <form action="{{ route('delivery.change_status_on_the_way', $row->id) }}" method="post">
                                        @csrf
                                        @method('PUT')

                                        <button class="btn btn-warning" data-abc="true"> <i class="fa fa-truck"></i> Update status -> On the way </button>
                                    </form>
                                ...
                                <form action="{{ route('delivery.change_status_ready_for_pick_up', $row->id) }}" method="post">
                                    @csrf
                                    @method('PUT')

                                    <button class="btn btn-warning" data-abc="true"> <i class="fa fa-box"></i>  <i class="fa fa-check"></i> Update status -> Ready for Pick up </button>
                                </form>
